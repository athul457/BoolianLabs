...
const Hero = () => {
  return (
    <section className="relative bg-gray-950 text-white pt-40 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            <div className="inline-flex items-center px-4 py-1 rounded-full bg-green-500/20 text-green-400 text-sm font-medium mb-6">
              Boolean Technologies
            </div>
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-xl">
              We build scalable, modern systems powered by cutting-edge
              technology and stunning UI.
            </p>

            <Link
              to="/contact"
              className="px-8 py-4 bg-gradient-to-r from-blue-600 to-green-500 rounded-full font-semibold flex items-center shadow-xl hover:scale-105 transition"
            >
              Start Your Project
          ...
          {/* RIGHT SIDE 3D */}
          <motion.div
            className="flex-1 w-full h-[500px] rounded-3xl overflow-hidden shadow-2xl"
            initial={{ opacity: 0, x: 60 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          >
            <iframe
              src="https://my.spline.design/YOUR-SCENE-LINK"
              frameBorder="0"
              width="100%"
              height="100%"
              title="3D Hero"
