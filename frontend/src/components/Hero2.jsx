...
import { Link } from 'react-router-dom';
import { ArrowRight, Smartphone, Search, Globe, Award } from 'lucide-react';
import { motion } from 'framer-motion';
import WhatsAppIcon from './WhatsAppIcon';

const Hero = () => {
  return (
    <section className="relative bg-white dark:bg-gray-900 text-gray-900 dark:text-white pt-40 pb-20 lg:py-32 transition-colors duration-300">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold mb-6 leading-tight tracking-tight">
              Transform your{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-teal-500 to-green-500">
                digital presence
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Link
                to="/portfolio"
                className="px-8 py-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full font-bold hover:border-green-500 hover:text-green-600 dark:hover:text-green-400 transition-all flex items-center justify-center"
              >
                View Work
              </Link>
            </div>
            ...
            {/* TRUST METRICS */}
            <div className="flex items-center space-x-8 border-t border-gray-200 dark:border-gray-700 pt-6">
              <div>
                <p className="text-2xl font-bold">50+</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">Projects Done</p>
              </div>
          ...
          >
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl p-8 shadow-xl space-y-6">

              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-bold">Growth-Focused Solutions</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    All-in-One Solution
                  </p>
                </div>
                <div className="bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-3 py-1 rounded-full text-xs font-semibold flex items-center">
                  <Award className="h-4 w-4 mr-1" /> Top Quality
                </div>
              </div>

              <Feature icon={Globe} title="Custom Development" subtitle="Tailored to You" />
              <Feature icon={Smartphone} title="Mobile Responsive" subtitle="Perfect on Any Device" />
              <Feature icon={Search} title="SEO Optimization" subtitle="Rank Higher" />
