        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            <Link to="/" className="flex items-center space-x-2 text-2xl font-bold text-gray-900 dark:text-white mb-6 group">
              <img src="/favicon.svg" alt="Boolean Technologies Logo" className="h-20 w-20 group-hover:scale-110 transition-transform duration-300" />
              <span className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-green-500 bg-clip-text text-transparent font-dancing ml-2">Boolean Technologies</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600 dark:text-gray-400">+91 7676074209</span>
              </li>
              <li className="flex items-center">
                <div className="bg-blue-100 dark:bg-blue-900/30 p-2 rounded-lg mr-3 shrink-0">
                    <Mail className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                </div>
                <span className="text-gray-600 dark:text-gray-400">hello@booleantechnologies.com</span>
              </li>
            </ul>
          </div>
        </div>
