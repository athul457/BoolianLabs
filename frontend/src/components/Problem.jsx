// import { ArrowDown, AlertTriangle, SearchX, History, Smartphone, TrendingDown } from 'lucide-react';
...
const Problem = () => {
  ...
  return (
    <section className="py-12 bg-white dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-[95%] mx-auto bg-blue-50/50 dark:bg-blue-900/10 rounded-[3rem] py-12 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <div className="inline-flex items-center justify-center px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full mb-6">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <ArrowDown className="h-8 w-8 text-green-600 dark:text-green-400 mx-auto mb-4" />
...
const ProblemCard = ({ item, index }) => {
  ...
  return (
    <motion.div
      ...
      className="p-6 md:p-8 bg-white dark:bg-gray-800 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-2"
    >
