...
const Home = () => {
  return (
    <main className="overflow-x-hidden">
      <SEO 
        title="Home" 
        description="Boolean Technologies - We build best websites and digital experiences for businesses." 
        keywords="web design, digital agency, web development, SEO, marketing"
      />
      <Hero />
      <Suspense fallback={<div className="h-screen bg-white dark:bg-gray-900 flex items-center justify-center text-blue-600 dark:text-blue-400"><div className="animate-spin h-8 w-8 border-4 border-current border-t-transparent rounded-full" /></div>}>
        <Problem />
        <Services />
        <WhyChooseUs />
        <Portfolio />
